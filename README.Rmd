...
You can access a data frame containing the full inventory of content areas, indicators, and measures in the R environment after the package is loaded using the command below.

```{r load_data_cached, eval=TRUE}
