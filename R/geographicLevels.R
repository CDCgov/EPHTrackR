...
#' geographicLevels(measure=c("Number of summertime (May-Sep) heat-related deaths, by year","Number of extreme heat days","Number of months of mild drought or worse per year"),format="name")
#' geographicLevels(measure=c("Number of summertime (May-Sep) heat-related deaths, by year","Number of extreme heat days","Number of months of drought per year"),format="shortName")
#' geographicLevels(content_area = 25,format="ID")
#' geographicLevels(indicator="Historical Heat Days",content_area ="DR",format="shortName")
#' geographicLevels(measure="Number of summertime (May-Sep) heat-related deaths, by year" ,indicator="Historical Extreme Heat Days and Events",content_area ="Drought",format="name")
#' @export
