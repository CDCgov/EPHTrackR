...
#' @param smoothing Specify whether to return geographically smoothed measure data (1) or not (0). The default value is 0 since smoothing is not available for most measures. Requesting smoothed data when it is not available will produce an error.
#' @return This function returns a list with each element containing a data frame corresponding with each combination of the specified measures and geographic types/stratification levels. Note that certain data values may be suppressed in accordance with CDC guidelines intended to protect individual privacy.
#' @examples \dontrun{
#' 
#' 
