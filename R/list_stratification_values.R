...
#' @title List available stratification values
...
#' @return This function returns a list with each element containing a data frame corresponding with all combinations of specified measures and geographic types. Within each row of the dataframe is a another nested data frame containing the stratification values. If the specified measure and associated geography type do not have any "Advanced Options" stratifications, the returned list element will be empty.
#' @examples \dontrun{
