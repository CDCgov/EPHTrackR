...
#' @param smoothing Specifies whether to return stratification levels for geographically smoothed versions of a measure (1) or not (0). The default value is 0 since smoothing is not available for most measures. Requesting smoothed data when it is not available will produce an error.
