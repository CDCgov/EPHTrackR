...
#' @return The output of this function is a list with a separate element for each geography type available for the specified measure (e.g., state, county). Each row in the data frames contained as elements in the list shows the a stratification available for the measure.
#' @examples \dontrun{
#' 
